...
# also extract gene expression matrix, transpose to get samples x probes
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \appendix
% \section{Loading data, background info}
% \section{Preprocessing}\label{appendix:preprocessing}
% This appendix covers some less interesting preprocessing. First we remove a set
% of probes related to blood type that aren't interesting wrt cancer; the
% \Rfunction{blood\_probes} function returns the NuIDs of these probes.
% %<<remove_hist_echo, ref.label='remove_hist', eval=FALSE, echo=TRUE>>=
% %@
